...
//        set2.addAll(list1);
        ...
        Map<String, Double> map = teachers.stream().collect(
                Collectors.toMap(Teacher::getName, Teacher::getSalary)
        );
...
//        List<Integer> list2 = new ArrayList<>(Arrays.asList(a));
        ...
        List<Integer> list2 = Arrays.stream(a).boxed().toList();
