...
//        File f1 = new File("E:/resource/dlei.jpg");
//        File f1 = new File("JavaSE_Plus/JavaSE_plus_day03_IOStrem/txtdir");
//        System.out.println("File .length "+f1.length()); // 字节个数
//        System.out.println("File name " + f1.getName());
//        System.out.println("File exists " + f1.exists());
//        System.out.println("File isFile " + f1.isFile());
//        System.out.println("File isDirectory " + f1.isDirectory());
//        System.out.println("File absoluteFile" + f1.getAbsoluteFile());
...
//
        File f5 = new File("JavaSE_Plus/JavaSE_plus_day03_IOStrem/t2/txt3");
        System.out.println("mkdirs f5 " + f5.mkdirs()); // mkdir可以创建多级文件夹，很重要！
//
