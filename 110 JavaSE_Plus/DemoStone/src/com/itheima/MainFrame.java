...
public class MainFrame extends JFrame {
    // 设置图片位置
    private static final String imagePath = "JavaSE_Plus/DemoStone/image/";
    private static final String minScorePath = "JavaSE_Plus/DemoStone/src/score.txt";
...
//        JLabel countTxt2 = new JLabel("最少步数：" + minCount + "步");
        ...
        if (minCount != 0) {
            countTxt2.setText("最少步数：" + minCount + "步");
        } else {
            countTxt2.setText("没有历史步数");
        }
    ...
    private void writeFileScore(int count) {
        try (
                FileWriter fw = new FileWriter(minScorePath);
    ...
    private int readFileScore() {
        try (
                FileReader fr = new FileReader(minScorePath);
