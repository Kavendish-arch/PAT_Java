package com.file.demo8filewriter;
...
//    }
    public static void main(String[] args) {
        try (
                // 1. 创建一个字符输出对象与文件接通
//                Reader fr = new FileReader("JavaSE_Plus/JavaSE_plus_day03_IOStrem/img/03.txt");
//                Writer fw = new FileWriter("JavaSE_Plus/JavaSE_plus_day03_IOStrem/img/03.txt", true);
                FileWriter fw = new FileWriter("JavaSE_Plus/JavaSE_plus_day03_IOStrem/img/03.txt", true);
        ) {
            // 2. 写入数据
            fw.write("java");
            fw.write("\r\n");
